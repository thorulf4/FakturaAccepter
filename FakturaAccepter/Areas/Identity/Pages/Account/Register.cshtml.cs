...
namespace FakturaAccepter.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string inviteKey, string returnUrl = null)
        {
            if (!inviteManager.IsKeyValid(inviteKey))
                return Redirect("~/");
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            string role = inviteManager.UseKey(InviteKey);
            InviteKey = "";
